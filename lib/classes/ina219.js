...
var Ina219 = /** @class */ (function () {
    function Ina219() {
                ...
                return __generator(this, function (_b) {
                    switch (_b.label) {
                        ...
                        case 2:
                            ...
                            this.calValue = 4096;
                            return [4 /*yield*/, this.writeRegister(ina219_register_const_1.INA219_REGISTER.CALIBRATION, this.calValue)];
                        case 3:
                            _b.sent();
                            return [4 /*yield*/, this.setBusRange(ina219_bus_voltage_range_const_1.INA219_BUS_VOLTAGE_RANGE.RANGE_32V)];
                        case 4:
                            _b.sent();
                        ...
                        case 9:
                            err_1 = _b.sent();
                            if (!this.i2cBus) return [3 /*break*/, 13];
                            _b.label = 10;
                        case 10:
        ...
        this.getCurrent_mA = function () { return __awaiter(_this, void 0, void 0, function () {
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.readInaRegister(ina219_register_const_1.INA219_REGISTER.CALIBRATION)];
                    case 1:
                        activeCalValue = _a.sent();
                        if (!(activeCalValue !== this.calValue)) return [3 /*break*/, 3];
                        console.warn('Calibration Lost!');
                        return [4 /*yield*/, this.writeRegister(ina219_register_const_1.INA219_REGISTER.CALIBRATION, this.calValue)];
                    case 2:
                        _a.sent();
                        _a.label = 3;
                    case 3: return [4 /*yield*/, this.readInaRegister(ina219_register_const_1.INA219_REGISTER.CURRENT)];
        ...
        this.getPower_mW = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.writeRegister(ina219_register_const_1.INA219_REGISTER.CALIBRATION, this.calValue)];
                    case 1:
                        _a.sent();
                        return [4 /*yield*/, this.readInaRegister(ina219_register_const_1.INA219_REGISTER.POWER)];
                    case 2: return [2 /*return*/, ((_a.sent()) * 20)];
                }
            });
        }); };
        /**
         ...
         */
        this.getCalibration = function () { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.readInaRegister(ina219_register_const_1.INA219_REGISTER.CALIBRATION)];
                    case 1: return [2 /*return*/, _a.sent()];
        ...
        this.getAll = function () { return __awaiter(_this, void 0, void 0, function () {
            var activeCalValue, promises, result;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0: return [4 /*yield*/, this.readInaRegister(ina219_register_const_1.INA219_REGISTER.CALIBRATION)];
                    case 1:
                    ...
                    case 3:
                        promises = [
                            this.readInaRegister(ina219_register_const_1.INA219_REGISTER.BUSVOLTAGE),
                            this.readInaRegister(ina219_register_const_1.INA219_REGISTER.SHUNTVOLTAGE),
                            this.readInaRegister(ina219_register_const_1.INA219_REGISTER.CURRENT),
                            this.readInaRegister(ina219_register_const_1.INA219_REGISTER.POWER),
                        ];
         ...
         * @param value
         */
        this.setBusRange = function (value) { return __awaiter(_this, void 0, void 0, function () {
            var conf;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
